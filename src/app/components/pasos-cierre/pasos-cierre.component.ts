...
startTimer() {
  ...
  openDialog(): void {
    const dialogRef = this.dialog.open(DialogEventoPasos, {
      width: '60%',
      height: '80%', 
...
@Component({
  ...
  templateUrl: 'agregar-pasos-cierre.component.html',
  styleUrls: ['./pasos-cierre.component.css']
})
export class DialogEventoPasos {

  constructor(
    public dialogRef: MatDialogRef<DialogEventoPasos>,
