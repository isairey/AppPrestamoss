...
@Component({
  selector: 'app-limpieza-archivos',
  templateUrl: './limpieza-archivos.component.html',
  styleUrls: ['./limpieza-archivos.component.css']
})
export class LimpiezaArchivosComponent implements OnInit {
...
startTimer() {
  ...
  openDialog(): void {
    const dialogRef = this.dialog.open(DialogArchivos, {
      width: '60%',
      height: '80%', 
...
export class DialogArchivos {

  constructor(
    public dialogRef: MatDialogRef<DialogArchivos>,
